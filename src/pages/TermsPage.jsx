...
const TermsPage = () => {
  ...
  return (
    <main style={{ paddingTop: '120px', minHeight: '100vh', backgroundColor: 'var(--color-bg-gray)' }}>
      <Helmet>
        <title>Terms of Service | SignalRise Studio</title>
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem 6rem' }}>
        ...
        <div style={{ background: 'white', padding: '3rem', borderRadius: 'var(--border-radius)', boxShadow: 'var(--shadow-md)' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>SignalRise Studio ("we", "us") provides website design, development, and related digital services to clients ("you"). The specific scope, deliverables, and payment terms for each project are agreed upon in a separate written proposal or contract.</p>
          </section>
          ...
          <section>
            ...
            <p>For any questions regarding these terms, contact us at <a href="mailto:hello@signalrisestudio.com" style={{ color: 'var(--color-accent-blue)' }}>hello@signalrisestudio.com</a>.</p>
          </section>
        </div>
      </div>
    </main>
