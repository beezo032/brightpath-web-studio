...
const PrivacyPage = () => {
  ...
  return (
    <main style={{ paddingTop: '120px', minHeight: '100vh', backgroundColor: 'var(--color-bg-gray)' }}>
      <Helmet>
        <title>Privacy Policy | Signal Light Studio</title>
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem 6rem' }}>
        ...
        <div style={{ background: 'white', padding: '3rem', borderRadius: 'var(--border-radius)', boxShadow: 'var(--shadow-md)' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>You may request to view, correct, or delete any personal data we hold about you at any time by contacting us at <a href="mailto:hello@signallightstudio.com" style={{ color: 'var(--color-accent-blue)' }}>hello@signallightstudio.com</a>.</p>
          </section>

          <section>
            <h2 style={{ fontSize: '1.3rem', marginBottom: '0.75rem' }}>6. Contact</h2>
            <p>For any privacy-related questions, contact us at <a href="mailto:hello@signallightstudio.com" style={{ color: 'var(--color-accent-blue)' }}>hello@signallightstudio.com</a>.</p>
          </section>
        </div>
      </div>
    </main>
